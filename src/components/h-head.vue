 ...
 * @Last Modified time: 2019-07-20 22:40:01
 * @文件说明: 页面头部组件
 */
<template>
    <div class="h-head" :style="{backgroundColor:headBgColor}">
        <h-tab/>
...
<script>
    ...
    export default {
        name: 'h-head',
        computed: {
            ...mapState(['currDesignRouter', 'currRouterTab']),
            headBgColor() {
                let bgcolor =
                    this.currRouterTab.bgcolor || this.currDesignRouter.bgcolor
